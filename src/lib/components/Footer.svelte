    ...
    >
      ...
      <div>
        ...
        >
          ...
          <li class="mb-5 last:mb-0">
            <a href="#" class="hover:text-shop-purple">Cameras & Photography</a>
          </li>
          <li class="mb-5 last:mb-0">
            <a href="#" class="hover:text-shop-purple">Video Games & Consoles</a
            >
          </li>
          <li class="mb-5 last:mb-0">
            <a href="#" class="hover:text-shop-purple">Waterproof Headphones</a>
          </li>
        </ul>
      </div>
      <div>
