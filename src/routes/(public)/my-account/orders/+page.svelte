<script lang="ts">
  ...
  console.log(
    "🚀 ~ file: +page.svelte:8 ~ previousOrders",
  ...
  const convertDate = (dateToConvert: Date) => {
    ...
    let stringifyDate = `${day}/${month}/${year}`;
...
<MyAccountGridSlot>
  ...
  <div>
    ...
    {#if previousOrders?.length === 0}
      <div
        class="mx-auto max-w-[400px] my-7 flex flex-col justify-center items-center"
      >
        <h3 class="text-shop-blue font-josefin text-xl">
