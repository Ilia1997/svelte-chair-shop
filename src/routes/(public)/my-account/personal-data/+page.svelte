   ...
   <div>
      ...
      >
         <div class="grid grid-cols-2 gap-[25px] mt-7">
            ...
            {formData?.error ? 'border-red-600 text-red-600' : 'border-gray-300 text-gray-900'}"
                  required
               />
            </div>
            <div>
         ...
         <button
            ...
            style:color={pageSettings?.buttonTextColor?.hex && pageSettings.buttonTextColor.hex}
            type="submit"
         ...
         <div class="grid grid-cols-2 gap-[25px] mt-5">
            <div>
               ...
               <input
                  ...
                  class="bg-gray-50 border  text-gray-900 text-base font-lato rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full px-4 py-2  min-h-[40px] 
      {userFormData?.error ? 'border-red-600 text-red-600' : 'border-gray-300 text-gray-900'}"
                  required
               />
            </div>
         </div>
